...
const config = {
  ...
  appDescription: "The fastest way to launch and lead a run club.",
  // REQUIRED (no https://, not trailing slash at the end, just the naked domain)
  domainName: "runclubat.com",
  crisp: {
  ...
  resend: {
    ...
    fromNoReply: `RunClubAt <noreply@resend.runclubat.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `Lawrence @ RunCLubAt <lawrence@resend.runclubat.com>`,
    // Email shown to customer if they need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "lawrence@runclubat.com",
  },
  colors: {
